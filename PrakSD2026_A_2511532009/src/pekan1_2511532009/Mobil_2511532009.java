...
public class Mobil_2511532009 {
	 ...
	 private ArrayList<Mobil_2511532009> daftarMobil;
	
	 public Mobil_2511532009() {
	     this.daftarMobil = new ArrayList<>();
	 }
	
	 public Mobil_2511532009(String nama, int tahun, int cc, double harga, String merk) {
	     this.nama = nama;
	     this.tahun = tahun;
	     this.cc = cc;
	     this.harga = harga;
	 ...
	 public ArrayList<Mobil_2511532009> getDaftarMobil() { return daftarMobil; }
	 ...
	 public void tambahMobil(Mobil_2511532009 m) {
	     daftarMobil.add(m);
	 ...
	 public void tampilkanSemua() {
	     ...
	     if (daftarMobil.isEmpty()) {
	         ...
	         for (Mobil_2511532009 m : daftarMobil) {
