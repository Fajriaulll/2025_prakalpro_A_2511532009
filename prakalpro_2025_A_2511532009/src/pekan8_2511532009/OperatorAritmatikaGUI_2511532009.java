...
public class OperatorAritmatikaGUI_2511532009 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					OperatorAritmatikaGUI_2511532009 frame = new OperatorAritmatikaGUI_2511532009();
	 ...
	 * Create the frame.
	 */
	public OperatorAritmatikaGUI_2511532009() {
		setResizable(false);
		...
		lblNewLabel.setFont(new Font("Papyrus", Font.BOLD, 12));
		lblNewLabel.setBounds(120, 10, 126, 20);
